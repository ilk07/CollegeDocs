...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('CollegeDocs\Model', MODX_CORE_PATH . 'components/collegedocs/src/', null, 'CollegeDocs\\');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/collegedocs/schema/collegedocs.mysql.schema.xml';
